...
- [ ] 分割表示。dividerの比率は0.1〜0.9に制限してsessionへ保存・復元し、副paneのcursor/selection/scroll/表示設定は独立保持するが、Zedの`PaneGroup`相当のpane tree、両paneのnative描画・入力は未実装
