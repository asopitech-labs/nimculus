...
**Color glyph contract：** `IDWriteFactory2::TranslateColorGlyphRun`でsurrogate emojiの色glyph translationを検証する。色glyphをR8 monochrome atlasへ混ぜず、既存のDirectWrite/D2D描画へ保持する。COLR/PNG/SVG等をRGBA GPU atlasへ移送する処理は未完了として残す。
