...
| M10：macOSターミナル・タスク | 🟡 自動検証済み・E2E対象 | PTY、VT/ANSI、複数session、task/cancel/problem matcher/output panelを実装。`Close Terminal`は現在のPTY process groupだけを終了し、残りのsessionを選択する。連続利用はE2Eで確認 |
